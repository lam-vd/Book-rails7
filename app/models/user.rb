class User < ApplicationRecord
    ...
    def create_reset_digest
        ...
        user_digest = User.digest(reset_token)
        update_columns(reset_digest: user_digest, reset_sent_at: Time.zone.now)
    end
    ...
    def feed
        ...
        Micropost.left_outer_joins(user: :followers).where(part_of_feed, { id: id}).includes(:user, image_attachment: :blob)
